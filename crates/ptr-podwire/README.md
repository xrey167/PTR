...
**Code footprint:** 4 Rust source files · 1464 nonblank source lines · 2 integration-test files · 24 `#[test]` markers
...
- Discovery, and any authority over the address a requester is given: a wrong address gets a refusal rather than a wrong Pod only because the request names the endpoint it is for
