...
**Code footprint:** 2 Rust source files · 121 nonblank source lines · 2 integration-test files · 2 test markers (`#[test]`, `#[tokio::test]`)
...
- Expand validated domain↔prost conversion to all frame types and canonical fixtures
