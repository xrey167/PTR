...
- Gold labels record source (oracle or human with annotator) and sampling (uniform or active); only uniform gold estimates accuracy
- Evaluation with Brier score, expected calibration error and Krippendorff agreement from ptr-analytics
