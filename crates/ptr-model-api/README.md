...
**Code footprint:** 4 Rust source files · 66 nonblank source lines · 2 integration-test files · 2 `#[test]` markers
...
- Resume/checkpoint/observation continuation protocol
