...
**Rust footprint:** 45 source files · 3241 nonblank source lines · 48 integration-test files · 66 `#[test]` markers
...
| [ptr-observe](../../crates/ptr-observe/README.md) | `scaffold` | 6 | 202 | 3 | 3 | 6 | 5 | F001:planned, E003:planned | observability:open |
