...
**Rust footprint:** 45 source files · 3324 nonblank source lines · 49 integration-test files · 71 `#[test]` markers
...
| [ptr-observe](../../crates/ptr-observe/README.md) | `scaffold` | 6 | 285 | 4 | 8 | 7 | 5 | F001:planned, E003:planned | observability:open |
