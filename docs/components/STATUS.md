...
**Rust footprint:** 131 source files · 28986 nonblank source lines · 101 integration-test files · 705 `#[test]` markers

| Component | Maturity | Rust files | LOC | Test files | Tests | Implemented items | Missing items | Experiments | Evaluations |
|---|---:|---:|---:|---:|---:|---:|---:|---|---|
| [ptr-analytics](../../crates/ptr-analytics/README.md) | `prototype` | 8 | 744 | 1 | 30 | 7 | 2 | F002:planned, F003:planned | analytics-mirror:open |
| [ptr-branch](../../crates/ptr-branch/README.md) | `prototype` | 7 | 1692 | 3 | 52 | 11 | 4 | S003:planned, F003:planned | — |
...
| [ptr-fastmem](../../crates/ptr-fastmem/README.md) | `prototype` | 9 | 1925 | 4 | 58 | 9 | 3 | M008:planned, L003:completed | fast-weight-memory:open |
...
| [ptr-labeling](../../crates/ptr-labeling/README.md) | `prototype` | 6 | 934 | 1 | 16 | 8 | 4 | F002:planned | label-model:open |
...
| [ptr-lineage](../../crates/ptr-lineage/README.md) | `prototype` | 7 | 1800 | 4 | 50 | 8 | 3 | R004:planned | adapter-serving:open |
...
| [ptr-pg](../../crates/ptr-pg/README.md) | `prototype` | 16 | 3899 | 2 | 23 | 21 | 4 | L004:completed, Q003:planned | relational-substrate:open, materialized-state:open, lexical-search:open, local-vector-search:open, event-streaming:open |
...
| [ptr-runtime](../../crates/ptr-runtime/README.md) | `prototype` | 6 | 4166 | 19 | 158 | 47 | 12 | E001:planned, E003:planned, E004:planned | — |
...
| [ptr-semdb](../../crates/ptr-semdb/README.md) | `prototype` | 2 | 666 | 3 | 26 | 16 | 5 | S001:planned, S002:planned, E004:planned | semantic-db:open |
