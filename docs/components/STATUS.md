...
**Rust footprint:** 40 source files · 2191 nonblank source lines · 38 integration-test files · 51 `#[test]` markers

| Component | Maturity | Rust files | LOC | Test files | Tests | Implemented items | Missing items | Experiments | Evaluations |
|---|---:|---:|---:|---:|---:|---:|---:|---|---|
| [ptr-config](../../crates/ptr-config/README.md) | `prototype` | 1 | 242 | 3 | 5 | 5 | 3 | E001:planned | — |
...
| [ptr-server](../../crates/ptr-server/README.md) | `scaffold` | 1 | 12 | 1 | 1 | 1 | 5 | E001:planned, E003:planned | — |
