...
**Rust footprint:** 131 source files · 29768 nonblank source lines · 101 integration-test files · 730 `#[test]` markers

| Component | Maturity | Rust files | LOC | Test files | Tests | Implemented items | Missing items | Experiments | Evaluations |
|---|---:|---:|---:|---:|---:|---:|---:|---|---|
| [ptr-analytics](../../crates/ptr-analytics/README.md) | `prototype` | 8 | 812 | 1 | 33 | 7 | 2 | F002:planned, F003:planned | analytics-mirror:open |
| [ptr-branch](../../crates/ptr-branch/README.md) | `prototype` | 7 | 1819 | 3 | 59 | 11 | 4 | S003:planned, F003:planned | — |
...
| [ptr-fastmem](../../crates/ptr-fastmem/README.md) | `prototype` | 9 | 2105 | 4 | 64 | 9 | 3 | M008:planned, L003:completed | fast-weight-memory:open |
...
| [ptr-labeling](../../crates/ptr-labeling/README.md) | `prototype` | 6 | 1010 | 1 | 21 | 8 | 4 | F002:planned | label-model:open |
...
| [ptr-lineage](../../crates/ptr-lineage/README.md) | `prototype` | 7 | 1839 | 4 | 52 | 8 | 3 | R004:planned | adapter-serving:open |
...
| [ptr-pg](../../crates/ptr-pg/README.md) | `prototype` | 16 | 4168 | 2 | 23 | 22 | 4 | L004:completed, Q003:planned | relational-substrate:open, materialized-state:open, lexical-search:open, local-vector-search:open, event-streaming:open |
