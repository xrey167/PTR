...
**Rust footprint:** 132 source files · 32917 nonblank source lines · 102 integration-test files · 808 `#[test]` markers
...
| [ptr-pg](../../crates/ptr-pg/README.md) | `prototype` | 16 | 5053 | 2 | 25 | 29 | 7 | L004:completed, Q003:planned | relational-substrate:open, materialized-state:open, lexical-search:open, local-vector-search:open, event-streaming:open |
