...
| P1 | Agentic substrate (doc 35): PostgreSQL projection substrate, certified branches, revocable fast memory, adapter lineage, weak supervision | prototype — anchor-verified projection, live-only derived caches, hybrid retrieval and working-state storage tested against a real server in CI; branches merge only through verified deltas; experiments L004, Q003, S003, F003, M008, L003, R004, F002 and E005 planned; TLS, roles, a business-table effect applier and lineage/labeling adapters remain |
