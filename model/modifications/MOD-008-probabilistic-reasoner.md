# MOD-008-probabilistic-reasoner

## Hypothesis
Update explicit distributions instead of collapsing predictions into hard labels.
...
## Primary metrics
calibration, proper scoring rules, decision utility
