# MOD-005-latent-recurrence

## Hypothesis
Perform recurrent latent reasoning steps without decoding every reasoning step as text.
...
## Primary metrics
task success/token, latency, step-budget calibration
